...
public class BluetoothMain extends Activity
{
    ...
    private Button responseYes;
    private Button responseNo;
    ...
    private void setupChat()
    {
        ...
        responseYes = (Button) findViewById(R.id.buttonYes);
        responseNo = (Button) findViewById(R.id.buttonNo);

        responseYes.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                sendMessage("1");
                Intent i = new Intent(BluetoothMain.this, AccessGranted.class);
                startActivityForResult(i, 0);
            }
        });

        responseNo.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                sendMessage("0");
                Intent i = new Intent(BluetoothMain.this, AccessDenied.class);
                startActivityForResult(i, 0);
            }
        });
